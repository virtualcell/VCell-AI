...
* If you are going to use math formulas or equations in your response, ensure that they are encapsulated between $...$ for inline math or $$..$$ for block math, so they render correctly in the frontend.
"""