...
def test_get_biomodels_success():
    response = client.get(
        "/biomodel?bmName=Calcium&category=all&startRow=1&maxRows=10&orderBy=date_desc"
    )
...
def test_get_biomodel_invalid_query():
    ...
    response = client.get(
        "/biomodel?bmName=InvalidModel&category=all&startRow=1&maxRows=10&orderBy=date_desc"
    )
...
def test_get_simulation_details_success():
    response = client.get(
        "/biomodel/271993644/simulations?bmId=271993644&simId=271993642"
    )
...
def test_get_simulation_details_invalid_simulation():
    ...
    response = client.get(
        "/biomodel/271993644/simulations?bmId=271993644&simId=999999999"
    )
