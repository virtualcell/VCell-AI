    ...
    const fetchFiles = async () => {
      try {
        ...
        const mockFiles: KnowledgeFile[] = [
          {
            id: "1",
            name: "VCell_API_Documentation.pdf",
            type: "pdf",
            size: 2048576,
            uploadDate: "2024-12-15T10:30:00Z",
            uploadedBy: "admin@example.com",
            description: "Complete API documentation for VCell integration",
            tags: ["api", "documentation", "integration"],
            status: "active"
          },
          {
            id: "2",
            name: "Biomodel_Templates.json",
            type: "json",
            size: 512000,
            uploadDate: "2024-12-14T14:20:00Z",
            uploadedBy: "moderator@example.com",
            description: "JSON templates for common biomodel structures",
            tags: ["templates", "biomodel", "json"],
            status: "active"
          },
          {
            id: "3",
          ...
          },
          {
            ...
            type: "archive",
            size: 5120000,
            uploadDate: "2024-12-10T08:20:00Z",
            uploadedBy: "admin@example.com",
            description: "Backup of old system data",
            tags: ["backup", "archive", "old"],
            status: "archived"
          }
        ]
